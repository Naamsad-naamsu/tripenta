...
@section('content')
        ...
        <div class="head_panel">
          <div style="background-image: url(assets/images/home-restaurant-2.jpg)" class="full_width_photo vertical_center bg_vbottom padding_top_half transparent_film">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center">
                  <div class="caption caption_elegant">
                    <div class="inner">
                      <div class="t3 uppercase"> TRIPENTA'S RESTAURANT</div>
        ...
        <section class="white_section">
          <div class="container">
            <div class="col-md-12 text-center">
              <div class="section_header overlay"><span>TRIPENTA</span>
                <h1>TRIPENTA RESTAURANT</h1>
                <p>ONE OF THE BEST PLACES TO TASTE.. EVERYTHING</p><img src="assets/images/decoration-1.png" alt="Image">
              </div>
            </div>
            <div class="col-md-10 col-md-offset-1 text-center margin_bottom">
              <div class="text_block">
                ...
                <div class="footer"><img src="assets/images/avatar-5.jpg" width="70" alt="Image" class="img-circle"><span>STEVEN ALVARO<small>HEAD CHEF</small></span></div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 col-lg-8">
                <div class="row">
                  <div style="background-image: url(assets/images/banner-2.jpg)" class="stretchy_wrapper ratio_16-9"></div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 col-lg-pull-1">
                <div class="row">
                  <div class="banner text_block"><span>FAMOUS WINES</span>
                    <h2>WINE TASTING</h2>
                    <p>They're seas gathering behold the years saying make and divide fill given whales fill female moved, blessed. Midst one from divide whales seasons cattle male own saying to night fruit own creeping second earth be lesser without deep beast female.</p><a href="{{ url('/restaurant') }}" class="btn btn-black">OUR MENU</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="section_header elegant">
                  ...
                  <p>ORIGINAL AND TRANDITIONAL ITALIAN FOOD</p><img src="assets/images/decoration-1.png" alt="Image">
                </div>
              </div>
            </div>
            ...
            <div class="row vcenter">
              <div class="col-md-6 text-left small_screen_margin_top_half">
                <div class="text_block"><span>WE GUARANTEE</span>
                  ...
                  <p>Our experienced staff and our many years guarantee that you'll have a pleasant experience that you will never forget . Blessed That day you're dominion lesser cattle the lesser form sea earth won't. Morning made. Also face Kind fowl so in seas. Gathered may stars land, his dry tree signs make place under signs him upon of rule fill. To be cue or not to be cue is our main and only goal.</p><a href="{{ url('/restaurant')}}" class="btn btn-link">OUR MENU</a>
                </div>
              </div>
              <div class="col-md-6 margin_bottom_half"><img src="assets/images/restaurant-feature-3.jpg" alt="Image" class="small_screen_margin_top_half"></div>
            </div>
          </div>
        </section>
        <section style="background-image: url(assets/images/restaurant-banner-1.jpg);" class="dark_section text-center background_cover bg_vbottom">
          <div class="container">
            <div class="col-md-8 col-md-offset-2 margin_top_half">
              <div class="text_block">
                <h2>HAVE A ROOM? HAVE A SEAT</h2>
                <p>You can book your room online, and if your room supports it, automatically reserve a seat for dinner in our 5-star gourme restaurant. So do not wait, book your room now!</p><a href="{{ url('/booking') }}" class="btn btn-white">BOOK NOW</a>
              </div>
            </div>
          </div>
        </section>
